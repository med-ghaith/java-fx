...
public class AddReviewCoachController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
      /*  Review r1 = reviewservice.getReviewByUserByCoach(id, coachI);
 ...
 /*   public void addReview(ActionEvent event){
        if (id == 0){
            ...
            Comment c = new Comment(id, coachI, txt.getText());

            Comment c1 = commentservice.getCommentByUserByCoach(id, coachI);
            //System.out.println(r);
//       rat.setPartialRating(true);
            Review r = new Review(id, coachI, (float) rat.getRating());
            Review r1 = reviewservice.getReviewByUserByCoach(id, coachI);
            System.out.println(r1.getRate());
            //System.out.println(r1);
            if (r.getIdCoach() != r1.getIdCoach()) {
                commentservice.addCommentCoach(c);
                reviewservice.addReviewCoach(r);
...
//        }
                ...
                reviewservice.updateReviewCoach(new Review(id, coachI, (float) rat.getRating(), r1.getId()));
            ...
            alert.setOnCloseRequest((e) -> {
                try {
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/views/ShowReviewCoach.fxml"));
                    Parent root = loader.load();
                    ShowReviewCoachController rc = loader.getController();
                    Comment c2 = commentservice.getCommentByUserByCoach(c.getIdUser(), c.getIdCoach());
...
//               DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
                    ...
                    Logger.getLogger(AddReviewCoachController.class.getName()).log(Level.SEVERE, null, ex);
                }
            });
            alert.showAndWait();
        }
